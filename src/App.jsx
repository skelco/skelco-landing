...
const WORK = [
  { title: "Lovesac Event Microsite", image: "https://picsum.photos/seed/lovesac/800/600", result: "↑ 38% event sign-ups", tags: ["Next.js", "Edge", "CMS"] },
  { title: "Native Union Store",      image: "https://picsum.photos/seed/native/800/600",  result: "+24% conversion rate", tags: ["Shopify", "Hydrogen", "CRO"] },
  { title: "Goodman Theatre Redesign",image: "https://picsum.photos/seed/goodman/800/600", result: "+31% time on page",    tags: ["Accessibility", "Design system"] },
  { title: "Healthcare Portal",       image: "https://picsum.photos/seed/health/800/600",  result: "-42% support tickets", tags: ["React", "RBAC", "Testing"] },
];
...
const TESTIMONIALS = [
  {
    ...
    role: "COO, DTC Brand",
    quote:
      "Best vendor we’ve hired. They ship fast, communicate clearly, and focus on outcomes—not just pixels.",
  },
  {
    name: "Cayla B.",
    role: "Director of Marketing",
    quote:
      "Traffic jumped 52% after launch. The design is beautiful and the site is blazing fast on mobile.",
  },
  {
    name: "Eric M.",
    role: "Founder, SaaS",
    ...
    <div className="min-h-screen w-full bg-neutral-950 text-neutral-100 overflow-x-hidden">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/70 border-b border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-2" onClick={closeMobile}>
            <Sparkles className="h-5 w-5 text-indigo-400" />
            <span className="font-semibold tracking-tight">Skel Co Industries</span>
          </a>
          ...
          {mobileOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-3">
                ...
                <Button className="w-full bg-indigo-500 hover:bg-indigo-400" asChild>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="max-w-3xl">
            <Badge className="bg-white/10 text-white hover:bg-white/20">
              Phoenix-Based • Remote Across the U.S.
            </Badge>
      ...
      <section id="work" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp}>
          <div className="flex items-end justify-between gap-6">
            ...
            <a href="#contact" className="text-sm text-indigo-400 hover:text-indigo-300">
              Book a walkthrough →
            </a>
          </div>
              ...
              <Card key={w.title} className="bg-white/5 border-white/10 overflow-hidden">
                ...
                <CardContent className="pt-0">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {w.tags.map((t) => (
                      <Badge key={t} className="bg-white/10 text-white hover:bg-white/20">
                        {t}
                      </Badge>
                    ))}
                  </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp}>
            ...
            <p className="mt-2 text-neutral-300 max-w-2xl">
              End-to-end delivery: from research and UX to production-ready code and launch. Pick a sprint or retain us long-term.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-2 text-neutral-300 max-w-md">
                Get a free roadmap and quote in 24 hours. We’ll review goals, budget, and timeline and respond with options.
              </p>
              <ul className="mt-6 space-y-2 text-sm text-neutral-300">
                ...
                <li className="flex items-center gap-2">
                  <Star className="h-4 w-4 text-yellow-400" /> Dedicated PM • Slack comms
                </li>
              </ul>
            </div>
